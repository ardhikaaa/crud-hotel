...
<html lang="en">
    <head>
        ...
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="#">Expro Hotel</a>
            <!-- Sidebar Toggle-->
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <h2 class="mt-3 ms-5">Data Admin</h2>
                    <!-- tambah data -->
                    <a href="tambahdata.php" class="btn btn-success mt-5 ms-5">Tambah Data</a>
                ...
                <table class="container table table-striped table-hover text-center mt-3">
                    ...
                    <tbody>
                        ...
                        <td>
                        <a class="edit btn btn-success badge p-2" href="editadmin.php?id_admin=<?php echo $row['id_admin']; ?>">EDIT</a>
                        <a class="hapus btn btn-danger badge p-2" href="hapus.php?id_admin=<?php echo $row['id_admin']; ?>">HAPUS</a>
                        </td>
                        </tr>
                    </tbody>
                    <?php
