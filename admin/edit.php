            ...
            <div id="layoutSidenav_content">
                ...
                <div class="container ps-5">
                    <form action="updateproses.php" method="POST">
                        <div class="mb-3 ">
                        <h2 class="mt-3">Edit Data Admin</h2>
                            <label for="exampleInputEmail1" class="form-label">Nama</label>
                            <input type="text" name="nama" style="width: 50%" value="<?php echo $row['nama'] ?>" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                            <input type="hidden" name="id" value="<?php echo $row['id_admin'] ?>">

                        </div>
                        <div class="mb-3">
                            <label for="exampleInputPassword1" class="form-label">Username</label>
                            <input type="text" name="usn" style="width: 50%" value="<?php echo $row['username'] ?>" class="form-control" id="exampleInputPassword1">
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputPassword1" class="form-label">Password</label>
                            <input type="password" name="pw" style="width: 50%" value="<?php echo $row['password'] ?>" class="form-control" id="exampleInputPassword1">
                        </div>
