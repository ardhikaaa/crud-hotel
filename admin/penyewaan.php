        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                ...
                <table class="container table table-striped table-hover text-center mt-3">
                    <thead>
                        <h2 class="text-center mt-5 pb-3">Daftar Penyewaan kamar</h2>
                        <tr>
                        <th scope="col">No</th>
                    ...
                    <?php
                        $query = "SELECT tbl_penyewa.*, tbl_jenis_kamar.jenis_kamar, tbl_jenis_kamar.harga FROM tbl_jenis_kamar INNER JOIN tbl_penyewa ON tbl_jenis_kamar.id_kamar = tbl_penyewa.id_kamar";
