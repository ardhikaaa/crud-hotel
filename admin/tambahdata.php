    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                ...
                <h2 class="mt-3">Tambah Data Admin</h2>
        ...
        <form action="updateproses.php" method="POST">
            ...
            <input type="text" class="form-control" id="floatingPassword" placeholder="Password" name="usn">
            <label for="floatingPassword">Username</label>
                </div>
                <div class="form-floating mb-3">
            <input type="password" class="form-control mt-3" id="floatingInput" placeholder="name@example.com" name="pw">
